...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PERPUSTAKAAN ARYAK</strong></a>
        </div>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="cek_login.php" class="form-horizontal" role="form" action="<?php echo site_url('login');?>" method="post">
...
<a href="<?php echo base_url(); ?>Login/admin" class="form-control" > Admin ? </a>

<a href="formlogin/ini.php" class="form-control" > Halo  </a>
